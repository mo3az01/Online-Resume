...
// $("#main").append(skills[0]);
 ...
 // var skills = ["Android","Java","Front-End","Back-End "];
 // var formattedName = HTMLheaderName.replace("%data%","Moaz Rashad");
 // var formattedRole = HTMLheaderRole.replace("%data%","Software Engineer");
 // var formattedMobile = HTMLmobile.replace("%data%","01147400177");
 // var formattedImage = HTMLbioPic.replace("%data%","images/fry.jpg");
